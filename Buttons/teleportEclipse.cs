...
public class TeleportEclipse : CustomActionButton
{
    ...
    public override float Cooldown => OptionGroupSingleton<TeleporterEclipseOptions>.Instance.TeleportCooldown;

    public override float EffectDuration => OptionGroupSingleton<TeleporterEclipseOptions>.Instance.TeleportDuration;
